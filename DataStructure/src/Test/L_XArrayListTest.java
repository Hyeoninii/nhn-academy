...
/**
 * XArrayList 클래스의 JUnit 테스트 클래스입니다.
 *
 * 이 클래스는 XArrayList 클래스의 모든 메서드를 테스트합니다.
 * 각 테스트 메서드는 XArrayList 클래스의 메서드가 올바르게 동작하는지 확인합니다.
 *
 * @author 작성자 이름
 */
class L_XArrayListTest {
    ...
    @Test
    void addAll() {
        XList<String> otherList = new XArrayList<String>();
    ...
    void forEach() {
        ...
        assertDoesNotThrow(() -> arrayList.forEach(System.out::println));
